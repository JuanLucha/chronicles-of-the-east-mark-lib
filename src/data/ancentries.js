import { languages, getRandomLanguage, getRandomLanguageOtherThan } from "./languages.js";
import { classes } from "./classes.js";
import { sizes } from "./sizes.js";

export default const ancestries = {
	"human": {
		name: "Humano",
		modifiers: {
			"str": 0,
		...
		traits: {
			"size": sizes.Medium,
			"speed": 10,
			"languages": [languages.Common, getRandomLanguageOtherThan([languages.Common])],
			"preferredClass": [
				classes.Assassin,
				classes.Barbarian,
				classes.Bard,
	...
	"elf": {
		...
		special: [
			"ModifiCadores CoMo explorador: +2 a moverse en silen- cio, +2 a encontrar trampas.",
